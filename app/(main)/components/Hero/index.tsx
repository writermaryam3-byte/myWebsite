    ...
    <Container>
      <section className="flex flex-col-reverse gap-4 md:flex-row py-6 items-center justify-center md:justify-between">
        <div className="text-center md:text-right text-gray-50 flex flex-col gap-5 max-w-lg">
          ...
          <h3 className="group text-4xl gap-2 flex text-center justify-center md:justify-normal md:text-right">
            <span className="text-white text-center group-hover:text-pink-400 duration-200">
              أ/مريم
            </span>
